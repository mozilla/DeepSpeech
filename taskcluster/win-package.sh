...
cp ${DS_ROOT_TASK}/DeepSpeech/ds/native_client/dotnet/DeepSpeechConsoleNetCore/bin/x64/Release/netcoreapp3.1/DeepSpeechConsoleNetCore.exe ${TASKCLUSTER_ARTIFACTS}/
