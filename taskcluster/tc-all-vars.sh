...
# Also, always target first major branch release to ensure proper binary compatibility
SUPPORTED_NODEJS_VERSIONS=${SUPPORTED_NODEJS_VERSIONS:-10.0.0 11.0.0 12.7.0 13.0.0 14.0.0}
