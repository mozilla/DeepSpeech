...
def _load_checkpoint(session, checkpoint_path, train):
    ...
    if train and FLAGS.drop_source_layers > 0:
...
def load_or_init_graph(session, method_order, train=True):
    '''
    ...
    for method in method_order:
        ...
        if method == 'best':
            ...
            if ckpt_path:
                ...
                return _load_checkpoint(session, ckpt_path, train)
