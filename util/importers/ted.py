...
def read_data_sets(graph, data_dir, batch_size, numcep, numcontext, thread_count=8, limit_dev=0, limit_test=0, limit_train=0):
    ...
    # Create dev DataSet
    dev = _read_data_set(graph, data_dir, TED_DIR, "dev", thread_count, batch_size, numcep, numcontext, limit=limit_dev)

    # Create test DataSet
    test = _read_data_set(graph, data_dir, TED_DIR, "test", thread_count, batch_size, numcep, numcontext, limit=limit_test)

    # Create train DataSet
    train = _read_data_set(graph, data_dir, TED_DIR, "train", thread_count, batch_size, numcep, numcontext, limit=limit_train)
...
def _read_data_set(graph, data_dir, extracted_data, data_set, thread_count, batch_size, numcep, numcontext, limit=0):
    # Create stm dir
