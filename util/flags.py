...
def create_flags():
    ...
    tf.app.flags.DEFINE_string  ('embeddings_output_dir',      '',          'comma separated list of files specifying the dataset used for training. multiple files will get merged')
